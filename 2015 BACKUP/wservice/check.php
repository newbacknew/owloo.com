...
<body>
    <a href="http://198.204.242.84/wservice/access_token_3_1/set_access_token.php" target="_blank" class="access_token"><?=get_last_time_set_access_token()?></a>
    <h3>Países</h3>
    <table cellspacing="0">
        <tr>
            <th>TYPE</th>
        ...
        <tr>
            ...
            <td class="<?=($total_country == $aux?'ok':'alert')?>"><?=($total_country == $aux?'ok':'<a target="_blank" href="http://198.204.242.84/wservice/country_3_1/record_aux.php?type=country">alert</a>')?></td>
        </tr>
        <tr>
            <td>Edades</td>
            ...
            <td class="<?=($total_country*$total_age == $aux?'ok':'alert')?>"><?=($total_country*$total_age == $aux?'ok':'<a target="_blank" href="http://198.204.242.84/wservice/country_3_1/record_aux.php?type=country_age">alert</a>')?></td>
        </tr>
        <tr>
            <td>Lenguajes</td>
            ...
            <td class="<?=($total_country*$total_language == $aux?'ok':'alert')?>"><?=($total_country*$total_language == $aux?'ok':'<a target="_blank" href="http://198.204.242.84/wservice/country_3_1/record_aux.php?type=country_language">alert</a>')?></td>
        </tr>
        <tr>
            <td>Relaciones</td>
            ...
            <td class="<?=($total_country*$total_relationship == $aux?'ok':'alert')?>"><?=($total_country*$total_relationship == $aux?'ok':'<a target="_blank" href="http://198.204.242.84/wservice/country_3_1/record_aux.php?type=country_relationship">alert</a>')?></td>
        </tr>
        <tr>
            <td>Generaciones</td>
            ...
            <td class="<?=($total_country*$total_generation == $aux?'ok':'alert')?>"><?=($total_country*$total_generation == $aux?'ok':'<a target="_blank" href="http://198.204.242.84/wservice/country_3_1/record_aux.php?type=country_generation">alert</a>')?></td>
        </tr>
        <tr>
            ...
            <td class="<?=($total_country*$total_comportamiento == $aux?'ok':'alert')?>"><?=($total_country*$total_comportamiento == $aux?'ok':'<a target="_blank" href="http://198.204.242.84/wservice/country_3_1/record_aux.php?type=country_comportamiento">alert</a>')?></td>
        </tr>
        <tr>
            <td>Intereses</td>
            ...
            <td class="<?=($total_country*$total_interest == $aux?'ok':'alert')?>"><?=($total_country*$total_interest == $aux?'ok':'<a target="_blank" href="http://198.204.242.84/wservice/country_3_1/record_aux.php?type=country_interest">alert</a>')?></td>
        </tr>
    </table>
    ...
    <table cellspacing="0">
        ...
        <tr>
            ...
            <td class="<?=($total_region == $aux?'ok':'alert')?>"><?=($total_region == $aux?'ok':'<a target="_blank" href="http://198.204.242.84/wservice/region_3_1/record_aux.php?type=region">alert</a>')?></td>
        </tr>
        <tr>
            <td>Edades</td>
            ...
            <td class="<?=($total_region*$total_age == $aux?'ok':'alert')?>"><?=(($total_region*$total_age) == $aux?'ok':'<a target="_blank" href="http://198.204.242.84/wservice/region_3_1/record_aux.php?type=region_age">alert</a>')?></td>
        </tr>
        <tr>
            <td>Relaciones</td>
            ...
            <td class="<?=($total_region*$total_relationship == $aux?'ok':'alert')?>"><?=(($total_region*$total_relationship) == $aux?'ok':'<a target="_blank" href="http://198.204.242.84/wservice/region_3_1/record_aux.php?type=region_relationship">alert</a>')?></td>
        </tr>
        <tr>
            <td>Comportamientos</td>
            ...
            <td class="<?=($total_region*5 == $aux?'ok':'alert')?>"><?=(($total_region*5) == $aux?'ok':'<a target="_blank" href="http://198.204.242.84/wservice/region_3_1/record_aux.php?type=region_comportamiento">alert</a>')?></td>
        </tr>
        <tr>
            <td>Intereses</td>
            <td class="text-right"><?=formatNum($total_region*5)?></td>
            <td class="text-right"><? $aux = get_total_record('region_interest'); echo formatNum($aux); ?></td>
            <td class="<?=($total_region*5 == $aux?'ok':'alert')?>"><?=(($total_region*5) == $aux?'ok':'<a target="_blank" href="http://198.204.242.84/wservice/region_3_1/record_aux.php?type=region_interest">alert</a>')?></td>
        </tr>
    </table>
    ...
    <table cellspacing="0">
        ...
        <tr>
            ...
            <td class="<?=($total_city == $aux?'ok':'alert')?>"><?=($total_city == $aux?'ok':'<a target="_blank" href="http://198.204.242.84/wservice/city_3_1/record_aux.php?type=city">alert</a>')?></td>
        </tr>
        <tr>
            <td>Edades</td>
            ...
            <td class="<?=($total_city*$total_age == $aux?'ok':'alert')?>"><?=($total_city*$total_age == $aux?'ok':'<a target="_blank" href="http://198.204.242.84/wservice/city_3_1/record_aux.php?type=city_age">alert</a>')?></td>
        </tr>
        <tr>
            <td>Relaciones</td>
            ...
            <td class="<?=($total_city*$total_relationship == $aux?'ok':'alert')?>"><?=($total_city*$total_relationship == $aux?'ok':'<a target="_blank" href="http://198.204.242.84/wservice/city_3_1/record_aux.php?type=city_relationship">alert</a>')?></td>
        </tr>
        <tr>
            <td>Comportamientos</td>
            ...
            <td class="<?=($total_city*5 == $aux?'ok':'alert')?>"><?=($total_city*5 == $aux?'ok':'<a target="_blank" href="http://198.204.242.84/wservice/city_3_1/record_aux.php?type=city_comportamiento">alert</a>')?></td>
        </tr>
        <tr>
            <td>Intereses</td>
            <td class="text-right"><?=formatNum($total_city*5)?></td>
            <td class="text-right"><? $aux = get_total_record('city_interest'); echo formatNum($aux); ?></td>
            <td class="<?=($total_city*5 == $aux?'ok':'alert')?>"><?=($total_city*5 == $aux?'ok':'<a target="_blank" href="http://198.204.242.84/wservice/city_3_1/record_aux.php?type=city_interest">alert</a>')?></td>
        </tr>
    </table>
    ...
    <table cellspacing="0">
        ...
        <tr>
            <td><a href="http://owloo.com/wservice/fb_pages/call.php?type=page" target="_blank">Facebook Pages</a></td>
        ...
        <tr>
            <td><a href="http://owloo.com/wservice/twitter/call.php?type=profile" target="_blank">Twitter Profiles</a></td>
        ...
        <tr>
            <td><a href="http://owloo.com/wservice/twitter/call.php?type=klout" target="_blank">Twitter Klout</a></td>
        ...
        <tr>
            <td><a href="http://owloo.com/wservice/instagram/call.php?type=profile" target="_blank">Instagram Profiles</a></td>
