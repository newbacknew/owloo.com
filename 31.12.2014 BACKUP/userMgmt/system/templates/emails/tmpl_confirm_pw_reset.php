<?php
$email['title'] = "Confirmar cambio de contraseña";
$email['body'] = '<!-- 
...
<p>Hola {{username}}.</p>
<p>Gracias por querer cambiar la contraseña de tu cuenta de Owloo. <strong>Para confirmar la nueva contraseña, haz clic en el siguiente enlace:</strong></p>
<p><a href="{{site_url}}/login.php?reset={{resetcode}}">{{site_url}}/login.php?reset={{resetcode}}</a></p>
<p>Por motivos de seguridad hemos almacenado tu dirección IP: {{visitor_ip}}, si has recibido este mensaje y no has solicitado un cambio de contraseña, es probable que otro usuario haya introducido su dirección de correo electrónico por error. En este caso, no es necesario que hagas nada, el enlace quedará inactivo dentro de 2 horas.</p>
