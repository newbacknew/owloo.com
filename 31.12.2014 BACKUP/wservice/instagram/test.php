<?php
    ...
    $data = get_url_content("https://api.instagram.com/v1/users/11707579/media/recent/?client_id=04e770ce699e44eb80bcf26cf929aa5a&count=50&min_id=852245276472660847_11707579");
    $data = json_decode($data, true);
    
    //print_r($data); die();
    
    $user = 'Latamclick';
    $user_id = 9187952; //253310177
