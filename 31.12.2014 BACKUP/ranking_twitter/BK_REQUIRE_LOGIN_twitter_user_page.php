    ...
    <div class="owloo_main">
        <div class="owloo_country_section">
            ...
            <div class="owloo_country_content">
                ...
                <div class="owloo_right">
                    ...
                    <p>
                        <strong><?=$twitter_name?></strong> cuenta con <strong><?=number_format($followers_count, 0, '.', ' ')?> seguidores</strong> en todo el mundo, con <strong><?=number_format($tweetcount, 0, '.', ' ')?> tweets</strong> publicados. Actualmente le está <strong>siguiendo a <?=number_format($following_count, 0, '.', ' ')?> perfiles</strong>.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div<?=($hfflag == 1?' id="owloo_content_charts_preup" class="owloo_hide"':'')?>>
            <div class="owloo_country_section ">
                ...
                <div class="owloo_country_content owloo_country_content_tw_chart<?=(!$site->loggedin?' owloo_hide_data':'')?>">
            ...
            <div class="owloo_country_section">
                ...
                <div class="owloo_country_content owloo_country_content_tw_chart<?=(!$site->loggedin?' owloo_hide_data':'')?>">
                     <?php if(!$site->loggedin){ ?><?php if(!$site->loggedin){ ?><div class="owloo_hide_data_bg"></div><?php } ?><?php } ?>
            ...
            <div class="owloo_country_section">
                ...
                <div class="owloo_country_content owloo_country_content_tw_chart<?=(!$site->loggedin?' owloo_hide_data':'')?>">
                     <?php if(!$site->loggedin){ ?><div class="owloo_hide_data_bg"></div><?php } ?>
                     <div class="owloo_left owloo_tw_table_chart_more">
            ...
            <div class="owloo_country_section">
                ...
                <div class="owloo_country_content<?=(!$site->loggedin?' owloo_hide_data owloo_hide_data_tw_down':'')?>">
                     <?php if(!$site->loggedin){ include(FOLDER_INCLUDE.'owloo_require_login.php'); } ?>
                     <div class="owloo_tw_download">
                        <div id="owloo_tw_download_btn" class="owloo_btn owloo_btn_big owloo_btn_orange">Descargar ahora</div>
