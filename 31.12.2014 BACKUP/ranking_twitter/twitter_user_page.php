...
if ($fetch_cntr['owloo_user_id'] == "") {
	if (isset($_REQUEST["txttwittername"]) && $_REQUEST["txttwittername"] ){
        ...
        $tw_user_id = get_user_id($screenname);
        if(!empty($tw_user_id))
		    $parameters = "user_id=" . $tw_user_id;
        else
...
//echo '<h1>Nuevo usuario!</h1>';
					...
					$qry = $qry . " owloo_screen_name, owloo_user_photo, owloo_user_cover, owloo_user_description,";
