...
<body>
    <div class="owloo_description">
        Para descargar las estadísticas completas de @<?=$_SESSION['owloo_tw_download']?> con datos históricos, por favor compárte primero esta página
    </div>
    <div id="highly-configurable">
        <div id="lock-my-div" style="display: none;" class="owloo_tw_download_sl_content to-lock"  data-url="<?=URL_ROOT?>twitter-stats/userpage/<?=$_SESSION['owloo_tw_download']?>" data-tweet="Estadísticas de @<?=$_SESSION['owloo_tw_download']?> en Twitter http://owloo.com/twitter-stats/userpage/<?=$_SESSION['owloo_tw_download']?> #owloo">
