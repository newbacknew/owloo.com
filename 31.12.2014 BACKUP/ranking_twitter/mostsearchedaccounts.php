...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title><?php echo Most_Searched_Page_Title; ?></title>
        <link href="css/style.css" type="text/css" rel="stylesheet" />
        <meta name="description" content="<?php echo Most_Searched_Page_Desc; ?>" />
        <meta name="keywords" content="<?php echo Most_Searched_Page_Keyword; ?>" />
    </head>
    <body>
                            ...
                            <tbody>
                                <tr>
                                    <td style="font-size: 13px; font-weight: bold; color: #FFFFFF; background-color: #000000; padding:2px; text-align:center;">
                                        <?php echo Most_Searched_Account_Title;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            <td colspan="3" style="background-color: #000000;">
                                                <div id="accountListHeading">
                                                    <?php echo Most_Searched_Account_Result;?>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <?php
                                            ...
                                            {
                                                $qry = " SELECT count( a.owloo_user_id ) AS count, b.owloo_screen_name, b.owloo_user_language";
                                                $qry = $qry . " FROM owloo_profile_log a LEFT JOIN owloo_user_master b";
                                            ...
                                            {
                                                $qry = " SELECT count( a.owloo_user_id ) AS count, b.owloo_screen_name";
                                                $qry = $qry . " FROM owloo_profile_log a LEFT JOIN owloo_user_master b";
                                                $qry = $qry . " ON a.owloo_user_id = b.owloo_user_id";
                                                $qry = $qry . " GROUP BY a.owloo_user_id";
                                            }
