...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title><?php echo Lowest_Rated_Page_Title; ?></title>
        <link href="css/style.css" type="text/css" rel="stylesheet" />
        <meta name="description" content="<?php echo Lowest_Rated_Page_Desc; ?>" />
        <meta name="keywords" content="<?php echo Lowest_Rated_Page_Keyword; ?>" />
    </head>
    <body>
                            ...
                            <tbody>
                                <tr>
                                    <td style="font-size: 13px; font-weight: bold; color: #FFFFFF; background-color: #000000; padding:2px; text-align:center;">
                                        <?php echo Lowest_Rated_Account_Title;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        <tr>
                                            <td colspan="3" style="background-color: #000000;">
                                                <div id="accountListHeading">
                                                    <?php echo Lowest_Rated_Account_Result;?>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <b><?php echo Lowest_Rated_Count; ?></b>
                                            </td>
                                        </tr>
                                        <?php
                                            $cnt = 1;
