...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title><?php echo Filthiest_Page_Title; ?></title>
        <link href="css/style.css" type="text/css" rel="stylesheet" />
        <meta name="description" content="<?php echo Filthiest_Page_Desc; ?>" />
        <meta name="keywords" content="<?php echo Filthiest_Page_Keyword; ?>" />
    </head>
    <body>
                            ...
                            <tbody>
                                <tr>
                                    <td style="font-size: 13px; font-weight: bold; color: #FFFFFF; background-color: #000000; padding:2px; text-align:center;">
                                        <?php echo Filthiest_Account_Title;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="3" style="background-color: #000000;">
                                                <div id="accountListHeading">
                                                    <?php echo Filthiest_Account_Result;?>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <?php
                                            ...
                                            if($_GET["lang"] == "en" || $_GET["lang"] == "es")
                                            {
                                                ...
                                                $qry = $qry . " FROM owloo_tweet_curse_data a LEFT JOIN owloo_user_master b";
