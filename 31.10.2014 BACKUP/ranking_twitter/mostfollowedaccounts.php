...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title><?php echo Most_Followed_Page_Title; ?></title>
        <link href="css/style.css" type="text/css" rel="stylesheet" />
        <meta name="description" content="<?php echo Most_Followed_Page_Desc; ?>" />
        <meta name="keywords" content="<?php echo Most_Followed_Page_Keyword; ?>" />
    </head>
    <body>
                            ...
                            <tbody>
                                <tr>
                                    <td style="font-size: 13px; font-weight: bold; color: #FFFFFF; background-color: #000000; padding:2px; text-align:center;">
                                        <?php echo Most_Followed_Account_Title;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            <td colspan="3" style="background-color: #000000;">
                                                <div id="accountListHeading">
                                                    <?php echo Most_Followed_Account_Result;?>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <?php
                                            $cnt = 1;
                                            $qry = "";
                                            $qry = " SELECT owloo_screen_name, owloo_followers_count FROM owloo_user_master";
                                            ...
                                            while ($fetchdata = mysql_fetch_array($qrydata))
                                            {
                                                ...
                                                echo '<td>' . $cnt . '</td>';
                                                echo '<td>' . $acnm . '</td>';
                                                echo '<td>' . $fetchdata["owloo_followers_count"] . '</td>';
                                                echo '</tr>';
                                                $cnt = $cnt + 1;
                                            }
                                        ?>
