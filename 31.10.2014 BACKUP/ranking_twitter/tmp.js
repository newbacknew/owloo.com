(function () {
        ...
        attr: function (a, b) {
            ...
            c !== "d" && c !== "visibility" && (s = parseFloat(s));
                ...
                for (c in a) if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
                        ...
                        else if (c === "x" && h === "text") for (e = 0; e < g.childNodes.length; e++) f = g.childNodes[e], A(f, "x") === A(g, "x") && A(f, "x", d);
    ...
    if (!Z && !$) {
        Highcharts.VMLElement = F = {
            ...
            attr: function (a, b) {
                ...
                else for (c in a) if (d = a[c], l = !1, e = p[c] && p[c].call(this, d, c), e !== !1 && d !== null) {
                            e !== x && (d = e);
        ...
        var na = {
            ...
            color: function (a, b, c, d) {
                ...
                if (i) {
                    ...
                    if (c === "fill") if (i === "gradient") c = l.x1 || l[0] || 0, a = l.y1 || l[1] || 0, p = l.x2 || l[2] || 0, l = l.y2 || l[3] || 0, q = 'angle="' + (90 - I.atan((l - a) / (p - c)) * 180 / Ja) + '"', x();
                        else {
                            var j = l.r,
                                v = j * 2,
                                P = j * 2,
    ...
    ab.prototype = {
        ...
        defaultLabelFormatter: function () {
            ...
            else if (f && a >= 1E3) for (; f-- && g === x;) c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = Na(b / c, -1) + e[f]);
        ...
        getOffset: function () {
            ...
            else for (v in f) f[v].destroy(), delete f[v]; if (p && p.text && p.enabled !== !1) {
    ...
    qb.prototype = {
        ...
        inClass: function (a, b) {
            for (var c; a;) {
                if (c = A(a, "class")) if (c.indexOf(b) !== -1) return !0;
    ...
    R.prototype = {
        ...
        setData: function (a, b) {
            ...
            if (l > (d.turboThreshold || 1E3)) {
                ...
                if (Ca(f)) {
                    ...
                    k[i] = a[i], f += d;
                    this.xIncrement = f
                } else if (Ba(f)) if (p) for (i = 0; i < l; i++) d = a[i], j[i] = d[0], k[i] = d.slice(1, p + 1);
                    else for (i = 0; i < l; i++) d = a[i], j[i] = d[0], k[i] = d[1]
            } else for (i = 0; i < l; i++) if (a[i] !== x && (d = {
                        series: this
        ...
        processData: function (a) {
            ...
            if (m && this.sorted && (!k || d > k || this.forceCrop)) if (a = i.getExtremes(), i = a.min, k = a.max, b[d - 1] < i || b[0] > k) b = [], c = [];
        ...
        drawPoints: function () {
            ...
            if (m.enabled || this._hasPointMarkers) for (f = b.length; f--;) if (g =
                        b[f], d = g.plotX, e = g.plotY, k = g.graphic, i = g.marker || {}, a = m.enabled && i.enabled === x || i.enabled, l = c.isInsidePlot(d, e, c.inverted), a && e !== x && !isNaN(e) && g.y !== null) if (a = g.pointAttr[g.selected ? "select" : ""], h = a.r, i = o(i.symbol, this.symbol), j = i.indexOf("url") === 0, k) k.attr({
                ...
                for (H = 2; H--;) {
                    ...
                    if (m > 0) {
                        ...
                        for (C = 0; C < J; C++) {
                            ...
                            if (F < C && b[C] !== null) F = C;
                            else for (w < J - C + F && b[C] !== null && (F = w - J + C); b[F] === null;) F++;
                            L.push({
                                i: F,
                                y: b[F]
                            });
