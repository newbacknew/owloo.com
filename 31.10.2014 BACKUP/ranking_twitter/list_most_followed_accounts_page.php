<?php
    ...
    if(isset($_POST['page']) && is_numeric($_POST['page'])){
        if($_POST['page'] < 1)
            $page = 1;
        elseif($_POST['page'] > ceil((TWITTER_TOTAL_PROFILES/PAGER_PP)))
            $page = ceil((TWITTER_TOTAL_PROFILES/PAGER_PP));
        else
            $page = $_POST['page'];
    }
	
	$is_hispanic = '';
	if(isset($_POST['from_page']) && $_POST['from_page']=='hispanic_twitter')
