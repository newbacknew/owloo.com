...
function informarErrorActividades(){
	...
	$mensaje = 'Se ha detectado un error en la ejecución del script de captura de ranking de edades, idiomas y relaciones (61-80). Favor verificar estado.';
...
$query = "SELECT id_country, code FROM country WHERE id_country >= 61 AND id_country <= 80 ORDER BY 1;"; 
