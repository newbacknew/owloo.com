<?php
    ...
    function cron_get_page_details_from_fb($ids){
        $datos = file_get_contents('https://graph.facebook.com/fql?q=SELECT+page_id,username,name,about,description,pic_small,pic_cover,is_verified+FROM+page+WHERE+page_id+IN('.$ids.')');
