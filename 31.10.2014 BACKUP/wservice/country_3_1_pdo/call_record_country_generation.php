<?php
    ...
    foreach($generations as $fila){
        ...
        exec('php-cli '.$folder_path.'record_country_generation.php '.$_SERVER['argv'][1].' '.$_SERVER['argv'][2].' '.($_SERVER['argv'][3]*$total_generation).' '.$fila['id'].' '.$fila['key'].' c45a5f3b2cfa74ac94bd5bbfb2c5d6a5 > '.$log_path.'record_country_generation.log 2>&1 &');
