...
function informarErrorActividades(){
	...
	$mensaje = 'Se ha detectado un error en la ejecución del script de captura de ranking de edades, idiomas y relaciones (121-140). Favor verificar estado.';
...
$query = "SELECT id_country, code FROM country WHERE id_country >= 121 AND id_country <= 140 ORDER BY 1;"; 
