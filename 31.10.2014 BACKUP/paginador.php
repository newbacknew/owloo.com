...
<head>
    ...
    <meta property="og:url" content="<?=URL_ROOT?>facebook-stats/pages/<?=($_GET['ranking'])?>/" /> 
    <meta property="og:title" content="<?=($_GET['ranking']=='hispanic'?'Ranking de las páginas de Facebook en español - Owloo':'Ranking mundial de las mejores páginas de Facebook - Owloo')?>" /> 
    <meta property="og:description" content="<?=($_GET['ranking']=='hispanic'?'Ranking hispano de las páginas más populares en Facebook':'Ranking de las páginas más populares en Facebook de todo el mundo')?>. Con Owloo mide la cantidad de fans y el PTA de una página de Facebook." />
...
<p>Además se mide el crecimiento semanal de fans y su PTA (People Talking About).</p>"></span>
        ...
        <div class="owloo_ranking_content">
            ...
            <div class="owloo_ranking">
                <?php include('ranking_fb_page/paginador.php'); ?>
            </div>
        </div>
