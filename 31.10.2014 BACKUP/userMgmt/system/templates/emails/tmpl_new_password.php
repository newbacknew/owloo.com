...
<tr>
<td style="padding: 20px 20; font: normal 14px OpenSans,Arial,sans-serif; line-height: 24px; color: #333;"><br />Hola {{username}}.
<p>Gracias por cambiar la contrase&ntilde;a de tu cuenta de owloo.</p>
<p>La nueva contrase&ntilde;a es: <b>{{newpassword}}</b></a></p>
<p>Podr&aacute; cambiar la contrase&ntilde;a ingresando en configuración de tu cuenta.</p>
