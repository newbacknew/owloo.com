<?php
$email['title'] = "Felicidades, tu cuenta se encuentra activa!";
$email['body'] = '<!-- 
...
<br />
<p>Hola {{username}}.</p>
<p><i><b>Felicidades, tu cuenta se encuentra activa!</b></i></p>
<p> Introduciendo tus datos personales puede acceder a ella ingresando en el siguiente enlace de <a href="{{site_url}}/login.php"> iniciar sesi&oacute;n</a>.</p>
<p>El nombre de usuario es: <strong>{{username}}</strong> y la password es la que especificó al momento del registro.</p>
...
$email['variables'] = 'website_name,username,email,site_url';
