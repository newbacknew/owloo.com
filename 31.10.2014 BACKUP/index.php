...
<body>
    ...
    <div class="owloo_index_zone_2">
        <div class="owloo_main">
            <h3>Más de <span id="owloo_user_count"><?=file_get_contents(URL_ROOT.'wservice/user_count.php')?></span> profesionales, medios y agencias registradas</h3>
        </div>
    </div>
    ...
    <div class="owloo_main owloo_main_content">
        ...
        <div class="owloo_index_charts">
            <div class="owloo_index_charts_item">
                ...
                <div class="owloo_index_charts_porcent"><?=owlooFormatPorcent($g_mayor_crec_mes['cambio_number'], get_country_total_audience_for_date($g_mayor_crec_mes['id_country'], COUNTRY_DATE_LAST_UPDATE))?>%</div>
            ...
            <div class="owloo_index_charts_item">
                ...
                <div class="owloo_index_charts_porcent"><?=owlooFormatPorcent($g_mayor_crec_3_meses['cambio_number'], get_country_total_audience_for_date($g_mayor_crec_3_meses['id_country'], COUNTRY_DATE_LAST_UPDATE))?>%</div>
            ...
            <div class="owloo_index_charts_item">
                ...
                <div class="owloo_index_charts_porcent"><?=owlooFormatPorcent($g_mayor_decrec_mes['cambio_number'], get_country_total_audience_for_date($g_mayor_decrec_mes['id_country'], COUNTRY_DATE_LAST_UPDATE))?>%</div>
            ...
            <div class="owloo_index_charts_item">
                ...
                <div class="owloo_index_charts_porcent"><?=owlooFormatPorcent($g_mayor_decrec_3_meses['cambio_number'], get_country_total_audience_for_date($g_mayor_decrec_3_meses['id_country'], COUNTRY_DATE_LAST_UPDATE))?>%</div>
        ...
        <div class="owloo_index_charts">
            <div class="owloo_index_charts_item">
                ...
                <div class="owloo_index_charts_porcent"><?=owlooFormatPorcent($hh_mayor_crec_mes['cambio_number'], get_country_total_audience_for_date($hh_mayor_crec_mes['id_country'], COUNTRY_DATE_LAST_UPDATE))?>%</div>
            ...
            <div class="owloo_index_charts_item">
                ...
                <div class="owloo_index_charts_porcent"><?=owlooFormatPorcent($hh_mayor_crec_3_meses['cambio_number'], get_country_total_audience_for_date($hh_mayor_crec_3_meses['id_country'], COUNTRY_DATE_LAST_UPDATE))?>%</div>
            ...
            <div class="owloo_index_charts_item">
                ...
                <div class="owloo_index_charts_porcent"><?=owlooFormatPorcent($hh_mayor_decrec_mes['cambio_number'], get_country_total_audience_for_date($hh_mayor_decrec_mes['id_country'], COUNTRY_DATE_LAST_UPDATE))?>%</div>
            ...
            <div class="owloo_index_charts_item">
                ...
                <div class="owloo_index_charts_porcent"><?=owlooFormatPorcent($hh_mayor_decrec_3_meses['cambio_number'], get_country_total_audience_for_date($hh_mayor_decrec_3_meses['id_country'], COUNTRY_DATE_LAST_UPDATE))?>%</div>
        ...
        <h1 class="owloo_main_title_h1 owloo_index">
            Actividades e intereses de todo el mercado hispano
            <span class="owloo_msj_popup" data="Se mide el país hispano que obtuvo un mayor crecimiento durante el último mes. Se entiende como crecimiento el registro de cuentas nuevas en Facebook."></span>
        </h1>
        <div class="owloo_index_charts">
            <div class="owloo_index_charts_item">
